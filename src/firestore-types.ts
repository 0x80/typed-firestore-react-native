 ...
 */
import type { FirebaseFirestoreTypes, QueryConstraint } from "@react-native-firebase/firestore";

export type DocumentData = FirebaseFirestoreTypes.DocumentData;

export type DocumentReference<T extends FirebaseFirestoreTypes.DocumentData = DocumentData> =
  FirebaseFirestoreTypes.DocumentReference<T>;

export type CollectionReference<T extends FirebaseFirestoreTypes.DocumentData = DocumentData> =
